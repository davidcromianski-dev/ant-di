const enUsMessages = {
    ...
    languageNotSupported: (lang: string, currentLang: string) => `Language '${lang}' not supported. Keeping '${currentLang}'.`,
    noDependenciesRegistered: (className: string) => `No dependencies registered for ${className}. Use container.registerDependencies(${className}, [dependencies]) to register dependencies manually.`
};
